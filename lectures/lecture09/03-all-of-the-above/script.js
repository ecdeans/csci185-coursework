...
const changeTitle = () => {
    ...
    document.querySelector('h1').innerText = "naptime";
};
...
const addImage = () => {
    ...
    document.querySelector("#panel1").innerHTML += '<img src= "https://cdn.mos.cms.futurecdn.net/VSy6kJDNq2pSXsCzb6cvYF.jpg">Cat</imgg>'
};
